...
#define USRTABLE_PATH "bin/usertable.json"
...
class UserHandler
{
	...
	public:
		...
		/**
		 * @brief Stores the last state of the user table inside a file at USRTABLE_PATH
		 */
		~UserHandler();
		...
		static inline UserHandler &GetUserTable()
		{
			...
			static UserHandler usrHandler(USRTABLE_PATH);
			return usrHandler;
		}
};
