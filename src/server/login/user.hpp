...
namespace clas_digital
{
  ...
  class IUser
  {
    public:
       ...
       */
      virtual bool ConstructFromJSON(const nlohmann::json &js) = 0;
  ...
  class User : public IUser
  {
    public:
      ...
      bool ConstructFromJSON(const nlohmann::json &js) override;
  ...
  class UserTable
  {
    public:
      ...
      virtual debug::Error<ReturnValues> RemoveUser(std::string primary_key);
